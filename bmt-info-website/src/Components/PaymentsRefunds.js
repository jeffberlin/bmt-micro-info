    ...
    <div className="body-content">
      <Container className="page">
        <Row className="justify-content-center">
          ...
          <Col xl={10} lg={12} md={12} sm={12}>
            <p className="question">Pre-authorization hold:</p>
          </Col>
          <Col xl={10} lg={12} md={12} sm={12}>
            <div className="answer">
              <p>A pre-authorization hold is set in place to ensure that there are sufficient funds on your credit or debit card. Once we have confirmed that the funds are available, the pre-authorization reserve will be released. If your order fails, you may still see a pre-authorization hold on your account. This does not mean that you were charged for your failed order and your pre-authorization reserve will still be released back to your bank account. Funds can either re-appear immediately or within a billing cycle, depending on your bank's policy. For questions about when your funds will be released back to your account, we recommend reaching out to your bank.</p>
            </div>
          </Col>
        </Row>
      </Container>
