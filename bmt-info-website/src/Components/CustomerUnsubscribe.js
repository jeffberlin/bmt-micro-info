      ...
      <Container className="page">
        <Row className="justify-content-center">
          ...
          <Col xl={10} lg={12} md={12} sm={12}>
            ...
            <p className='body-text'>However, should you want us to delete your customer account at <a href="https://customers.bmtmicro.com" target="_blank" rel="noreferrer">https://customers.bmtmicro.com</a>, please contact <a href="mailto:webmaster@bmtmicro.com?subject=Help me configure notifications for my customer account">webmaster@bmtmicro.com</a> and request data removal as per GDPR.</p>
          </Col>
        </Row>
      </Container>
    </div>
