    ...
    <div className="body-content">
      <Container className="page">
        <Row className="justify-content-center">
          ...
          <Col xl={10} lg={12} md={12} sm={12}>
            <p className='body-text'>The email that you received from BMT Micro is a one-time mailing in direct response to a product or service you sold via us. When we sell a product, we send out various emails to the supplier. BMT MICRO DOES NOT MAINTAIN MAILING LISTS, so there is no need to unsubscribe.</p>
